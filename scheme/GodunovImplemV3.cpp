...
void
GodunovImplemV3<dim, device_t>::resize_auxiliary_data()
{
  ...
  m_Q_left.resize(num_owned + num_ghosts);
  m_Q_right.resize(num_owned + num_ghosts);
...
template <size_t dim, typename device_t>
uint64_t
GodunovImplemV3<dim, device_t>::total_mem_size_in_bytes()
{
  uint64_t total = 0;
  ...
  total += m_Q_left.allocated_size_in_bytes();
  total += m_Q_right.allocated_size_in_bytes();
...
template <size_t dim, typename device_t>
void
GodunovImplemV3<dim, device_t>::do_time_step(DataArrayBlock_t const & U,
                                             ...
                                             real_t                   dt)
{
  ...
  //
  this->compute_reconstructed_states_in_owned_and_ghosts(dt, IX);
  ...
  //
  this->compute_reconstructed_states_in_owned_and_ghosts(dt, IY);
  ...
  if constexpr (dim == 3)
  {
    this->compute_reconstructed_states_in_owned_and_ghosts(dt, IZ);
...
} // GodunovImplemV3<dim, device_t>::do_time_step

// =====================================================================
// =====================================================================
template <size_t dim, typename device_t>
void
GodunovImplemV3<dim, device_t>::convert_to_primitives_in_mirror_quads(DataArrayBlock_t U)
{
...
} // GodunovImplemV3<dim, device_t>::convert_to_primitives_in_mirror_quads

// =====================================================================
// =====================================================================
template <size_t dim, typename device_t>
void
GodunovImplemV3<dim, device_t>::convert_to_primitives(DataArrayBlock_t U)
{
...
} // GodunovImplemV3<dim, device_t>::convert_to_primitives

// =====================================================================
// =====================================================================
template <size_t dim, typename device_t>
void
GodunovImplemV3<dim, device_t>::compute_limited_slopes_in_owned_and_ghosts()
{
...
template <size_t dim, typename device_t>
void
GodunovImplemV3<dim, device_t>::compute_reconstructed_states_in_owned_and_ghosts(real_t dt,
                                                                                 int    direction)
{

  KALYPSSO_PROFILING_REGION_DEVICE(this->m_profiling_mgr, NUM_SCHEME_RECONSTRUCTED_STATES);

  // reshape flux to be a flux array in given direction
  const auto flux_block_sizes = get_flux_block_sizes<dim>(m_Q_ghosted.block_size(), direction);
  m_Q_left.reshape(flux_block_sizes);
  m_Q_right.reshape(flux_block_sizes);
...
} // GodunovImplemV3<dim, device_t>::compute_reconstructed_states_in_owned_and_ghosts

// =====================================================================
// =====================================================================
template <size_t dim, typename device_t>
void
GodunovImplemV3<dim, device_t>::compute_fluxes_and_store_in_owned_and_ghosts(real_t dt,
                                                                             int    direction)
{
  ...
  // ComputeFluxesAndStoreFunctor_implemv3<dim, device_t>::apply(this->m_config_map,
  //                                                             this->m_mesh_map.orchard_keys(),
  //                                                             this->m_mesh_map.get_amr_mesh_info(),
  //                                                             m_Fluxes,
  //                                                             m_Q_ghosted,
...
} // GodunovImplemV3<dim, device_t>::compute_fluxes_and_store_in_owned_and_ghosts

// =====================================================================
// =====================================================================
template <size_t dim, typename device_t>
void
GodunovImplemV3<dim, device_t>::compute_viscous_fluxes_and_store_in_owned_and_ghosts(real_t dt,
                                                                                     int direction)
{
...
} // GodunovImplemV3<dim, device_t>::compute_viscous_fluxes_and_store_in_owned_and_ghosts

// =====================================================================
// =====================================================================
template <size_t dim, typename device_t>
void
GodunovImplemV3<dim, device_t>::read_fluxes_and_update_in_owned(DataArrayBlock_t u_out,
                                                                real_t           dt,
                                                                int              direction)
{
...
} // GodunovImplemV3<dim, device_t>::read_fluxes_and_update_in_owned

// explicit template instantiation
template class GodunovImplemV3<2, kalypsso::DefaultDevice>;
template class GodunovImplemV3<3, kalypsso::DefaultDevice>;
