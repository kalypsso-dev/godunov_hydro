...
def weak_scaling_plot(machine):
    ...
    if machine == 'cea_he':
        ...
        perf_2d = np.array([1820, 3165, 5700, 10460, 19925, 41497, 75416, 153900, 242690, 407300])/1000
        #perf_3d = np.array([784.8, 1257.9, 1958.2, 3873.8, 7361.7, 14773.5, 29545.3, 56957.9, 109947.2, 200998.0])/1000
        perf_3d = np.array([792, 1357, 2257, 3702, 7021, 14045, 26833, 52972, 104062, 201000])/1000
    else:
