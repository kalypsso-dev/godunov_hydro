...
def weak_scaling_plot(machine):
    ...
    ax1p = ax1.twinx()
    ax1p.plot(nb_gpu, 100*perf_2d/perf_2d[0]/nb_gpu, color='g', label='2d weak scaling efficiency')
    ...
    ax2p = ax2.twinx()
    ax2p.plot(nb_gpu, 100*perf_3d/perf_3d[0]/nb_gpu, color='g', label='3d weak scaling efficiency')
