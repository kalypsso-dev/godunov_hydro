...
# input args
##############
# arg #1 [required]  : job filename template (e.g. job_topaze.sh.tmpl)
...
function usage() {
    ...
    puts_message "Example: ./submit_job_topaze.sh -j ./weak_scaling_3d/job_topaze.sh.tmpl -i ./weak_scaling_3d/test_blast_3d_replicated.ini.tmpl -g 2 -h 2 -k 2" 1>&2;
    puts_message "On topaze, you will also need to specify a project id; use option -p for that" 1>&2;
