...
def sod_plot(ini_filename):
    ...
    ax2.legend()
    ax3.legend()
    plt.suptitle('Shock-tube:\n aluminium with Mie-Gruneisen shockwave EOS at tEnd={}'.format(tEnd), fontsize=20)
    plt.show()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ini', type=str, default='test_sod_2d_alu.ini', help='kalypsso ini parameter file')
