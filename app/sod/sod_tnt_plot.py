...
def sod_plot(ini_filename):
    ...
    ax2.legend()
    ax3.legend()
    plt.suptitle('Shock-tube:\n TNT with Mie-Gruneisen JWL at tEnd={}'.format(tEnd), fontsize=20)
    plt.show()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ini', type=str, default='test_sod_2d_tnt.ini', help='kalypsso ini parameter file')
