                                                 ...
                                                 ConfigMap const &     config_map)
{
  ...
  Kokkos::parallel_for("kalypsso::godunov_hydro::InitTriplePointDataFunctor",
  ...
  ConfigMap const &                    config_map)
{
  ...
  {
    Kokkos::parallel_for("kalypsso::godunov_hydro::InitTriplePointRefineFunctor",
...
template <size_t dim, typename device_t>
void
InitTriplePoint<dim, device_t>::apply(SolverGodunovHydro<dim, device_t> & solver)
{
